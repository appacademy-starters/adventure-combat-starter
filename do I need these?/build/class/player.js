...
class Player extends character_1.Character {
  ...
  move(direction) {
    if (this.currentRoom) {
      ...
      // do I need to use roomList here to reference room numbers?
  ...
  takeItem(itemName) {
    if (this.currentRoom) {
      ...
      if (itemObj) {
        ...
        this.currentRoom.items = (0, array_utilities_js_1.newArrWithoutItem)(
  ...
  dropItem(itemName) {
    if (this.currentRoom) {
      ...
      if (dropItem) {
        this.items = (0, array_utilities_js_1.newArrWithoutItem)(
          this.items,
          dropItem
        );
